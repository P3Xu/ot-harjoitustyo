...
class TestInputOutput(unittest.TestCase):
    ...
    def test_first_write(self):
        ...
        self.assertEqual(self.io.write(query, [meal]), len(self.meals)+1)

        ingredient = self.ingredients.pop()
        ...
        self.assertEqual(self.io.write(query, [ingredient]), len(self.ingredients)+1)

        query = "INSERT INTO macgyver (cones, sticks) VALUES (?, ?)"
