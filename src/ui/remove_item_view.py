...
class RemoveItemView:
    ...
    def _show_confirm_request(self):
        ...
        label_pre = Label(parent_frame, text = text_pre)
        label_post = Label(parent_frame, text = text_post)
        label_item = Label(parent_frame, text = self._item)
    ...
    def _actions(self):
        parent_frame = Frame(self._frame, pady = 10)
